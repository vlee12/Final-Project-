...
>>>>>>> 9e6bae5852a19b55067225ae13751ee664cea65b
    """
...
class bow(items_or_weapons):
	...
	Args (player obj): 
        player which receives the bow
	Side effects: 
        prints out an archery-specific statement when the player uses it. 
    Returns(int): 
        the amount of damage which this weapon is able to do."""
    def __init__(self):    
        super().__init__()
        ...
        if monster.monster_health > 0 & damage_dict[player_count].health > 0:
            ...
            if question == "y":
                ...
                if question2 == "weapon":
                    ...
                    if damage_dict[player_count].spell == "heal":
